...
function listingStatus(listing:any) {
  if (listing.status === 'sold') return { label: 'Sold', className: 'statusSold' }
  if (listing.status === 'rented') return { label: 'Rented', className: 'statusRented' }
  if (listing.moderation_status === 'rejected') return { label: 'Rejected', className: 'statusRejected' }
  if (listing.moderation_status === 'approved' && listing.status === 'active') return { label: 'Approved', className: 'statusApproved' }
  return { label: 'Pending review', className: 'statusPending' }
}
